package com.appsdeveloperblog.productsservice.errorhandling;
...
public class ProductServiceErrorHandler {
	...
	public ResponseEntity<Object> handleOtherException(IllegalStateException ex, WebRequest webRequest){
